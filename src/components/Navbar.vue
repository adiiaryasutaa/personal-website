<template>
	<nav class="bg-transparent p-4">
		<div class="container flex flex-wrap justify-between items-center mx-auto">
			<router-link
				:to="{ name: 'home' }"
				class="self-center text-xl text-slate-900 font-capriola uppercase font-league-spartan whitespace-nowrap dark:text-slate-50"
			>
				{{ brand }}
			</router-link>
			...
			<div class="flex items-center md:order-3">
				<button
					...
					class="text-slate-600 p-4 hover:text-slate-800 dark:hover:text-slate-400"
				>
					<span v-if="isDark">
						<svg
			...
			<div class="hidden w-full md:block md:w-auto" id="mobile-menu">
				<ul
					class="flex flex-col font-medium mt-2 md:flex-row md:space-x-4 md:mt-0 md:text-sm"
				>
